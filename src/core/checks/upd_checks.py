...
# УПД.1 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.2 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.3 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.4 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.5 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.6 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.10 — АВТОМАТИЧЕСКАЯ (уровни 1,2,3)  (для УЗ-4 не требуется)
class UPD10Checker(BaseChecker):
    def __init__(self):
        super().__init__("УПД.10", "Блокировка при бездействии", "high", is_manual=False)
        self.required_levels = [1, 2, 3]   # по таблице: плюсы для 1,2,3
    def check(self) -> dict:
        try:
...
# УПД.13 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.14 — АВТОМАТИЧЕСКАЯ (все уровни)
...
# УПД.11 — РУЧНАЯ (уровни 1,2,3)  (для УЗ-4 не требуется)
...
# УПД.17 — РУЧНАЯ (только уровни 1 и 2)
